...
public class DetalleVentaProxyController {
    ...
    public ResponseEntity<?> proxyVentas(HttpServletRequest request,
        ...
        String targetUrl = "http://localhost:8088/api/detalleventa" + originalPath;
        ...
        if (method == HttpMethod.DELETE) {
            ...
            if (!"admin".equalsIgnoreCase(rol)) {
                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                        .contentType(MediaType.APPLICATION_JSON)
                        .body("{\"error\": \"Solo admin puede eliminar detalle ventas\"}");
            }
        }
